...
get_header(); ?>
	...
	<section class="archival_footer clearfix">
		...
		<div class="widget">
			...
			wp_list_categories( array( 'orderby' => 'slug', 'order' => 'ASCD', 'show_count' => 0, 'title_li' => '', 'number' => 10, 'child_of'=>$issues_cat->cat_ID ) ); ?>
			</ul>
		</div>
...
// tooltip tutorial: http://return-true.com/examples/map-orig.html
    ...
    function insertState()
    {
        ...
        // 2018: Color Heatmap
        if(stateObject.count < 3){
            randomColor = "#FF8088";
        } else if(stateObject.count < 6){
            randomColor = "#ED2632";
        } else {
            randomColor = "#C20712";
        }
